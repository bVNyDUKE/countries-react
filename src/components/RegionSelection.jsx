...
export default function RegionSelection({ setRegion }){
  ...
  return(
    <div className='w-1/2 lg:w-1/6 relative hover:cursor-pointer text-sm' >
      <div ref={triggerRef} className='flex justify-between items-center rounded-md shadow-md h-16 px-5 bg-white text-blue-955 dark:bg-blue-950 dark:text-white'>
      ...
      { show &&
      <div ref={nodeRef} className='bg-white dark:bg-blue-950 dark:text-white text-blue-960 p-6 absolute w-full mt-1 rounded-md shadow-md'>
