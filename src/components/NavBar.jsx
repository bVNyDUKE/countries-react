...
function DarkModeIcon(){
  ...
  return (
    <svg onClick={toggleDarkMode} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 hover:cursor-pointer dark:text-white transition-colors ease-in-out duration-1000" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
