    ...
    <div className="container m-auto mt-5 sm:mt-10 p-10 text-blue-955 dark:text-white">
      <div className="mb-20">
        <button
          ...
          className="flex justify-center items-center bg-white text-blue-955 dark:bg-blue-950 dark:text-gray-400 w-32 p-2 space-x-2 rounded-sm shadow-2xl transition-colors ease-in-out duration-1000"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-blue-955 dark:text-white transition-colors ease-in-out duration-1000"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      {isLoading ? (
        ...
        <div className="lg:flex lg:justify-start lg:space-x-10 transition-colors ease-in-out duration-1000">
          <img
            className="object-cover sm:w-[645px] sm:h-[465px] float-left"
            src={data.flags.svg}
          />
          ...
          <div className="clear-left">
            <div className="space-y-10">
              ...
              <div>
                ...
                {!Object.keys(data).includes("borders") ? (
                  <div className="flex items-center">No neighbor data</div>
                ) : namesIsLoading ? (
                  "Loading...."
                ) : namesError ? (
                  <div className="flex items-center">Error {error.message}</div>
                ) : (
